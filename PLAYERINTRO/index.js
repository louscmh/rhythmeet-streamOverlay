...
socket.onmessage = async event => {
    ...
    if (tempLeft != playerOne.innerHTML || tempRight != playerTwo.innerHTML) {
        ...
        adjustFont(playerOne, 370,60);
        playerTwo.innerHTML = tempRight;
        adjustFont(playerTwo, 370,60);
        await setPlayerDetails(playerOnePic, playerOneSeed, playerOneRank, tempLeft);
        await setPlayerDetails(playerTwoPic, playerTwoSeed, playerTwoRank, tempRight);
    }
}
